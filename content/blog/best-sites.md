...
Now you might be thinking, "Well, if there are lots of keyservers, how will I
...
cheat.sh is, obviously, a cheat sheet. You can access it in a browser, but
really it's supposed to work with curl (or their CLI). It offers references for
command-line tools, programming languages, even text editors like Vim and
Emacs.
...
Lets say I wanted a quick reference on how to use dictionaries in python (make
sure to scroll):
